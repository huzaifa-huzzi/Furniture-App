      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            InkWell(
              onTap: (){
                Get.to(() =>const  WishListChair(),transition: Transition.leftToRightWithFade ,duration:const  Duration(seconds: 2));
              },
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: mediaQuery.size.width * 0.1),
                child: Container(
            ...
            InkWell(
              onTap: (){
                Get.to(() =>const  WishListDesk(),transition: Transition.leftToRightWithFade,duration:const  Duration(seconds: 2));
              },
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: mediaQuery.size.width * 0.1),
                child: Container(
